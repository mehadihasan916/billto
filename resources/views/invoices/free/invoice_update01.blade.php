                ...
                <td class="title">
                    <div style="width: 200px; height: 60px;">
                        <img src="{{ public_path('storage/invoice/logo/' . $userInvoiceLogo->invoice_logo) }}"
                            width="200" height="55" style="display: block;" />
                    </div>
                </td>
                <td style="text-align: right;">
                    Invoice #: {{ $invoiceData->invoice_id }}<br>
                    Date: {{ $invoiceData->invoice_date }}<br>
                    Due: {{ $invoiceData->invoice_dou_date }}<br>
                    P.O: {{ $invoiceData->invoice_po_number }}
                </td>
            </tr>
        </table>
                ...
                <td width="50%">
                    <table class="total-table" style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: right;">
                                {{ number_format($subtotal = $invoiceData->subtotal_no_vat, 2) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: left;">Discount Amount
                                ({{ $tax = $invoiceData->discount_percent }}%):</td>
                            <td style="text-align: right;">
                                {{ number_format($invoiceData->discount_amounts, 2) }}</td>
                        </tr>
                        <tr>
                            <td>Receive Advance Amount({{ $invoiceData->currency }}):</td>
                            <td style="text-align: right;">
                ...
                <tr>
                    <td style="width: 50%; vertical-align: top; padding-right: 20px;">
                        ...
                        <ul style="font-size: 11px; color: #555; padding-left: 15px; margin: 0;">
                            <p style="">{{ $userInvoiceLogo->terms }}</p> <br>
                    ...
                    <td style="width: 50%; vertical-align: bottom; text-align: right;">
                        <div style="display: inline-block; text-align: center; width: 200px;">
                            <div>
                                <img src="{{ public_path('uploads/signature/' . $userInvoiceLogo->signature) }}"
