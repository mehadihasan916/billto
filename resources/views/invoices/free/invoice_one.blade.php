...
<head>
    <style>
        ...
        .pdf-repeat-header {
            ...
            border-bottom: 1px solid #0370BF;
        }
    ...
    <div class="invoice_body page">
        <section class="first_section">
            ...
            <div class="heading_area" style="color: #686868;">
                <div class="i_title">
                    <p style=" font-weight: 700; margin-right:40px; margin-top:30px;margin-bottom:10px;">
                        {{ __('messages.INVOICE') }} </p>
                </div>
            ...
            <div class="right_Side_bar">
                ...
                <div class="last_section">
                    <div class="left_terms_condition">
                        <p style="font-size: 16px; color: #0370BF; text-transform: uppercase;">
