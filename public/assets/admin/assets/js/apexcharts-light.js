...
$(function () {
  ...
  if ($('#ageGroup').length) {
    var options = {
      ...
      colors: [colors.primary, colors.warning, colors.secondary, colors.success, colors.info],
      legend: {
        show: true,
        position: "top",
        horizontalAlign: 'center',
      ...
      series: [2663, 11456, 8602, 1245, 1356],
      labels: ["14-19", "20-25", "26-30", "31-35", "36-40"] // Country names
  ...
  if ($('#regionalStatus').length) {
    var options = {
      ...
      colors: [colors.primary, colors.warning, colors.secondary, colors.success, colors.danger, colors.info],
      legend: {
        show: true,
        position: "top",
        horizontalAlign: 'center',
      ...
      series: [8251, 1413, 1343, 3801, 5252, 5262],
      labels: ["Dhaka", "Khulna", "Barishal", "Rajshahi", "Rangpur", "Chattogram"] // Country names
    };

    var chart = new ApexCharts(document.querySelector("#regionalStatus"), options);
    chart.render();
  }
  // Apex Pie chart end
